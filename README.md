...
__ensure_all_tiered(feature_tiers, features, outcome)__
...
__map_dummy_tiers(encoding_groups, feature_tiers, col_names)__
...
__build_background_knowledge(col_names, col_tiers)__
...
__edge_has_circle(edge, node_a, node_b)__
...
__remove_ambiguous_same_tier_edges(graph, col_tiers)__
